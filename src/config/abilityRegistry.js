...
export const ABILITY_REGISTRY = {
  ...
  ultimate_galaxy: {
    ...
    display: { name: "Galaxy", icon: "🌌", color: "blue_gold", animation: "galaxyUltimateCharge" },
    gameAction: { type: "SPECIAL_EVENT", value: "GALAXY_ULTIMATE" },
    scoreAction: { type: "ADD_ROUND", value: 1 },
  ...
  epic_impact: {
    ...
    display: { name: "REINICIA OPONENTES", icon: "💥", color: "red", animation: "epicImpactSmooth" },
    gameAction: { type: "SPECIAL_EVENT", value: "BULLET_STORM" },
    scoreAction: { type: "RESET_SCORE", value: 0 },
  ...
  cocazo: {
    abilityId: "cocazo",
    display: { name: "Cocazo", icon: "🥥", color: "tropical", animation: "cocazoSlam" },
    gameAction: { type: "VISUAL_EFFECT", value: "COCAZO" },
    scoreAction: { type: "NONE", value: 0 },
