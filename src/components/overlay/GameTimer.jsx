...
export function GameTimer({ timer: initialTimer }) {
  ...
  return (
    <div className="timer-container" style={{ display: "flex", flexDirection: "column", alignItems: "center", width: "78px", minWidth: "78px", flex: "0 0 78px" }}>
      <style>{`
        @keyframes cocoTimerDangerPulse { 0%,100% { filter:drop-shadow(0 0 3px #160b0b) drop-shadow(0 0 8px rgba(185,28,28,.8)); } 50% { filter:drop-shadow(0 0 4px #160b0b) drop-shadow(0 0 11px rgba(185,28,29,1)); } }
      ...
      <div
        ...
        style={{
          ...
          color: isIntermission ? "#ffd166" : isFiveMinuteAlert ? "#ef3030" : "#ffffff",
      ...
      >
        ...
        <span style={{
          color: isLastMinute ? "#ef3030" : "inherit",
